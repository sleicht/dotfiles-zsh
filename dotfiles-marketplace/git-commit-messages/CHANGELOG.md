...
- Add Read tool prerequisite before Write tool in `/commit_message` to prevent "File has not been read yet" errors when `.commit-message.txt` exists from a previous run
