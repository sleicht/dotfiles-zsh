...
brew "yabai"
brew "zopfli"
brew "zoxide" # Fast, configurable, shell plugin manager
brew "zsh" # UNIX shell (command interpreter)
brew "zsh-abbr" # Auto-expanding abbreviations manager for zsh, inspired by fish
...
cask "uhk-agent" if OS.mac?
cask "visualvm" if OS.mac?
cask "vlc" if OS.mac?
...
cask "font-noto-nerd-font" if OS.mac?
cask "font-zxgamut" if OS.mac?
