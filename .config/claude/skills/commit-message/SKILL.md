...
This skill analyzes git changes and creates improved commit messages following the Conventional Commits specification.

## Process

When invoked, I will:

1. Use `git diff --staged` to analyze staged changes (or `git show <commit-ref>` for existing commits)
2. Review recent commit history with `git log` to understand the project's commit message style
3. Create an improved commit message following Conventional Commits specification
4. Print out the message ready to use
