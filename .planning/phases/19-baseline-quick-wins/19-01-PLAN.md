...
- All three stages produce numeric results
  ...
  <done>Three-stage baseline measurements recorded with specific numbers for hyperfine mean, EPOCHREALTIME top bottlenecks, and zsh-bench latency metrics.</done>
</task>
